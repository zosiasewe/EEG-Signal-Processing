...
fprintf('\n   Creating and Saving Separate Plots\n');
...
savefig(fig1,'plot1_testF1.fig'); print(fig1,'plot1_testF1.png','-dpng','-r300');
...
savefig(fig2,'plot2_testAccuracy.fig'); print(fig2,'plot2_testAccuracy.png','-dpng','-r300');
...
savefig(fig3,'plot3_bestF1.fig'); print(fig3,'plot3_bestF1.png','-dpng','-r300');

% --------------------------
% Plot 4: Box plots of F1 score distributions by parameter set
fig4 = figure('Name','F1 Score Distribution by Parameter Set','Position',[50,50,1000,600]);
...
savefig(fig4,'plot4_F1_boxplot.fig'); print(fig4,'plot4_F1_boxplot.png','-dpng','-r300');
...
savefig(fig5,'plot5_polygonArea.fig'); print(fig5,'plot5_polygonArea.png','-dpng','-r300');
...
grid on;
savefig(fig6,'plot6_perf_vs_cost.fig'); print(fig6,'plot6_perf_vs_cost.png','-dpng','-r300');
...
savefig(fig7,'plot7_train_vs_test.fig'); print(fig7,'plot7_train_vs_test.png','-dpng','-r300');
...
savefig(fig8,'plot8_testRatioImpact.fig'); print(fig8,'plot8_testRatioImpact.png','-dpng','-r300');
...
set(gca,'XTick',1:length(set_names),'XTickLabel',set_names); xtickangle(45); grid on;
savefig(fig9,'plot9_F1_variance.fig'); print(fig9,'plot9_F1_variance.png','-dpng','-r300');

fprintf('All 9 figures saved as .fig and .png files.\n');
