...
param_configs.n_extracted_features_list = [15];
param_configs.k_selected_features_list = [10];
param_configs.mu_list = [30]; 
param_configs.lambda_list = [90]; 
            ...
            for lambda_numbers = lambda_list
                for mu_numbers = mu_list
                    ...
                    for run = 1:N_RUNS
                        ...
                        test_polygon_area_runs(run) = temp_metrics.PA;  % numeric scalar
